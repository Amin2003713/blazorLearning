...
public static class ServersRepository
{
    ...
    [
        new Server { Id = 1, Name = "Server1", City = "Toronto", IsOnline = true },
        new Server { Id = 2, Name = "Server2", City = "Toronto", IsOnline = true },
        new Server { Id = 3, Name = "Server3", City = "Toronto" },
        new Server { Id = 4, Name = "Server4", City = "Toronto", IsOnline = true },
        new Server { Id = 5, Name = "Server5", City = "Montreal", IsOnline = true },
        ...
        new Server { Id = 11, Name = "Server11", City = "Calgary", IsOnline = true },
